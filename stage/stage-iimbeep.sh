...
cd /var/www/webroots/stage-iimbeep.linkstreet.co
...
composer update ultron/iimbeep-portal
...
cp /opt/phpcredentials/iimbeep-credentials.php /tmp/credentials.php && cp /opt/ultron-core-scripts/php7/2020_01_27_update_serial_number_in_user_certificates.php /tmp/
