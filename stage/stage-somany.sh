...
cd /var/www/webroots/stage-somany.linkstreet.co
...
composer update ultron/somany-portal
...
cp /opt/phpcredentials/somany-credentials.php /tmp/credentials.php && cp /opt/ultron-core-scripts/php7/2020_01_27_update_serial_number_in_user_certificates.php /tmp/
