...
cd /var/www/webroots/stage-max.linkstreet.co
...
composer update ultron/max-portal
...
cp /opt/phpcredentials/max-credentials.php /tmp/credentials.php && cp /opt/ultron-core-scripts/php7/2020_01_27_update_serial_number_in_user_certificates.php /tmp/
