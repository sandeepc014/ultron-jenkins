...
cd /var/www/webroots/stage-coursecube.linkstreet.co
...
composer update ultron/coursecube-portal
...
cp /opt/phpcredentials/coursecube-credentials.php /tmp/credentials.php && cp /opt/ultron-core-scripts/php7/2020_01_27_update_serial_number_in_user_certificates.php /tmp/
